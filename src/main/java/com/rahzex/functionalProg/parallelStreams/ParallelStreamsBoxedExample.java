package com.rahzex.functionalProg.parallelStreams;

import java.util.List;
import java.util.stream.Collectors;
import java.util.stream.IntStream;

// This is an example of when you should not use parallel stream.
// math operations with primitive data types are very fast in java, most it won't require any parallel processing
// but then you should always do a performance check before going with parallel stream
