...
public class PredicateAndConsumerExample {
    ...
    // Consumer<T> : Functional Interface that represents an operation that accepts a single input argument and returns no result.
    // Predicate<T> : Functional Interface that represents an operation that accepts a single input argument and returns boolean.
